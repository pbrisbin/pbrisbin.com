...
![raury coverage](http://images.pbrisbin.com/raury/coverage.png)\ 

* Useful debug output

![raury debug output](http://images.pbrisbin.com/raury/debug.png)\ 

* Clean code

![raury code](http://images.pbrisbin.com/raury/code.png)\ 
